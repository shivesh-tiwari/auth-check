...
auth_router.post('/register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const verifyExistingUser = yield conn.query(checkExistingUserSQL, username);
        ...
        const api_key_response = yield conn.query(`select json_extract(apikeys,'$') as apikeys from authuser where username='${username}'`);
        res.json({
